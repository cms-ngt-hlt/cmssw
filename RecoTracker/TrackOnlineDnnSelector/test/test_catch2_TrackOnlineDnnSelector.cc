...
static constexpr auto s_tag = "[TrackOnlineDnnSelector]";

TEST_CASE("Standard checks of TrackOnlineDnnSelector", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TrackOnlineDnnSelector"
