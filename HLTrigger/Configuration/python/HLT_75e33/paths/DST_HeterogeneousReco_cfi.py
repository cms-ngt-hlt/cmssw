...
from ..modules.hltPhase2PixelVerticesSoA_cfi import hltPhase2PixelVerticesSoA as _hltPhase2PixelVerticesSoA
...
hltExtendedPhase2PixelVerticesSoA = _hltPhase2PixelVerticesSoA.clone(pixelTrackSrc = 'hltExtendedPhase2PixelTracksSoA')
